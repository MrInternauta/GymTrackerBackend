...
export class migration1684956903877 implements MigrationInterface {
  name = 'migration1684956903877';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "repetitions" ("id" SERIAL NOT NULL, "weight" integer NOT NULL, "reps" integer NOT NULL, CONSTRAINT "PK_982d067008201c60e85bcdc9de0" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "repetitions_routines" ("id" SERIAL NOT NULL, "exercise_id" integer NOT NULL, "routine_id" integer, CONSTRAINT "PK_a3974abb488a474609b824c2185" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "routines" ("created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updateAt" TIMESTAMP, "deletedAt" TIMESTAMP, "id" SERIAL NOT NULL, "name" character varying(255) NOT NULL, "description" text NOT NULL, CONSTRAINT "UQ_2138b731d1e80c16717122f179a" UNIQUE ("name"), CONSTRAINT "PK_6847e8f0f74e65a6f10409dee9f" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "repetitions_routines" ADD CONSTRAINT "FK_962ae5ba350e66cee2a3bebd9c3" FOREIGN KEY ("exercise_id") REFERENCES "exercises"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "repetitions_routines" ADD CONSTRAINT "FK_e3f8a8690190e9eea70210a6e44" FOREIGN KEY ("routine_id") REFERENCES "routines"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "repetitions_routines" DROP CONSTRAINT "FK_e3f8a8690190e9eea70210a6e44"`);
    await queryRunner.query(`ALTER TABLE "repetitions_routines" DROP CONSTRAINT "FK_962ae5ba350e66cee2a3bebd9c3"`);
    ...
    await queryRunner.query(`DROP TABLE "repetitions_routines"`);
